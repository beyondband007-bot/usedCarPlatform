...
const mappings = [
  ...
  ['src/assets/img/icon/logo/日间模式logo.png', 'src/assets/media/global/global-footer-brand-logo-light.png'],
  ...
  ['src/assets/img/展厅灯光/场景选择/暖调米棚.png', 'src/assets/media/workspace/showroom/scene/workspace-showroom-scene-warm-beige.png'],
  ['src/assets/img/展厅灯光/场景选择/深灰光晕.png', 'src/assets/media/workspace/showroom/scene/workspace-showroom-scene-dark-gray-halo.png'],
  ['src/assets/img/展厅灯光/场景选择/炭灰岩墙.png', 'src/assets/media/workspace/showroom/scene/workspace-showroom-scene-charcoal-stone.png'],
  ['src/assets/img/展厅灯光/场景选择/竖光展厅.png', 'src/assets/media/workspace/showroom/scene/workspace-showroom-scene-vertical-light.png'],
