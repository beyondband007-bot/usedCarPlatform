...
<template>
  ...
  >
    <img
      ...
      alt="黑色豪华汽车湖边展示"
    />
    <div class="absolute inset-0 bg-gradient-to-r from-[#080a10] via-[#080a10]/80 to-[#080a10]/20"></div>
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_24%_40%,rgba(214,179,111,0.18),transparent_32%)]"></div>
