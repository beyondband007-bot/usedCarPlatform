...
const outputAndNegativeRule =
  "不要人物、不要杂物、不要额外文字、不要车牌号，不要生成多辆车。指定画幅比例汽车电商主图，1K，真实汽车广告摄影。";
