...
const baseNegativeRule =
  "不要人物、不要杂物、不要额外文字、不要车牌号，不要生成多辆车，不要重复车辆，不要悬浮车辆，不要车体扭曲，不要轮胎畸形，不要明显改色，不要改变车型。指定画幅比例汽车电商主图，真实汽车广告摄影。";

const logoNegativeRule =
  "不要人物、不要杂物、不要原车牌号，不要生成多辆车，不要重复车辆，不要悬浮车辆，不要车体扭曲，不要轮胎畸形，不要明显改色，不要改变车型。指定画幅比例汽车电商主图，真实汽车广告摄影。";
