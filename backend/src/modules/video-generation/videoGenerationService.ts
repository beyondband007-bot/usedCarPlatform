...
> = {
  ...
  "ref-video-006": {
    title: "车辆品质承诺",
    referenceRole: "强调车源优质、层层质检合格，突出车商对车辆品质的重视，让用户直观感受车商的靠谱。",
    styleTags: ["车场介绍", "品质营销", "精品二手车", "数字人口播"],
    stylePrompt:
      "精品二手车销售口播风格。强调车源优质、层层质检合格，突出车商对车辆品质的重视，让用户直观感受车商的靠谱；避免绝对化承诺。",
    shotPlan15s: [
      {
        timeRange: "0-3s",
  ...
  "ref-video-004": {
    title: "全方位实车讲解",
    referenceRole: "根据车辆五维信息，自动获取车辆卖点，详细讲解全车概况，降低车商营销成本。",
    styleTags: ["单车品介绍", "产品概况营销", "外观展示", "内饰展示", "数字人讲解"],
    stylePrompt: "根据车辆五维信息，自动获取车辆卖点，详细讲解全车概况，降低车商营销成本。",
    shotPlan15s: [
      {
        timeRange: "0-3s",
...
const platformVoiceCatalog: PlatformVoiceOption[] = [
  {
    ...
    label: "亲和女声",
    provider: "minimax",
    providerVoiceId: "Chinese (Mandarin)_Warm_Bestie",
    gender: "female",
    tags: ["讲解", "温和", "门店介绍"],
  ...
  },
  {
    ...
    label: "活力女声",
    provider: "minimax",
    providerVoiceId: "female-tianmei",
    gender: "female",
    tags: ["促销", "短视频", "明快"],
    model: env.minimax.speechModel,
    speed: 1.15,
...
const videoTemplateNarrationInstructionById: Record<string, string> = {
  "ref-video-001":
    "用于介绍车卖场，真实二手车车场介绍风格，全方位介绍车场资源，传播品牌价值，提高品牌知名度；避免绝对化承诺。",
  "ref-video-002":
    "用于介绍车卖场，展示车场规模、主推品牌车辆等，为车商的实力与资源背书，增强客户信任感；必须模糊表达，不说具体多少辆。",
  "ref-video-003":
    "用于介绍车卖场，以老朋友聊天式介绍车辆情况、价格情况，直击买车用车痛点，降低用户买车顾虑。",
  "ref-video-006":
    "用于介绍车卖场，强调车源优质、层层质检合格，突出车商对车辆品质的重视，让用户直观感受车商的靠谱；避免绝对化承诺。",
  "ref-video-008":
    "用于介绍车卖场，直观展示商家车源充足、选择丰富、更新稳定的经营实力，提升用户咨询与成交转化率；必须模糊表达，不说具体多少辆。",
  "ref-video-009":
    "用于介绍车卖场，突出车商库存更新节奏稳定，每周都有新车到店，提醒客户随时都有新车源可看、可选；不要夸大宣传。",
  "ref-video-010":
    "用于介绍车卖场，以自然口播风和真实车场画面传递“所见即所得”，帮助商家建立客户信任。",
  "ref-video-011":
    "用于介绍车卖场，以严选精品车、拒收泡水车与重大事故车为标准，展现商家车源优质、车况透明；避免绝对化承诺。",
  "ref-video-012":
    "用于介绍车卖场，突出车商售后实力，买车后有问题能联系、能沟通、有人对接，让本地及海外客户都更安心；不要夸大宣传。",
  "ref-video-013":
    "用于介绍车卖场，帮助商家传递“一车一况一价”的诚信经营理念，让本地及海外客户远程看车也更放心。",
  "ref-video-014":
    "用于介绍车卖场，展示商家在车辆品牌与渠道资源优势，从而提升客户的咨询兴趣与到店意愿。",
  "ref-video-015":
    "用于介绍车卖场，展示全天候运营与及时沟通能力，提升客户信任度，打造车商服务贴心、周到的形象。",
  "ref-video-004":
    "用于介绍用户上传的车辆，根据车辆五维信息自动获取车辆卖点，详细讲解全车概况，降低车商营销成本；不得编造用户未提供的配置或车况信息。",
  "ref-video-007":
    "用于介绍用户上传的车辆，强调车商产品适配海外市场需求、手续资料相对齐全等优势，提升客户远程咨询与采购信心；不要夸大宣传。",
  "ref-video-016":
    "用于介绍用户上传的车辆，全方位展示车辆外观成色、漆面光泽与整体质感，助力车商提升客户看车兴趣与咨询意愿；不得使用绝对化表达。",
  "ref-video-017":
    "用于介绍用户上传的车辆，展示车辆加速响应、行驶质感与动力情况，让客户更直观判断车辆状态，提升品牌形象；不要使用“完美”等过于绝对化的形容词。",
  "ref-video-018":
    "用于介绍用户上传的车辆，展示车辆内饰成色、座椅磨损与实用配置，让客户直观看到车内状态和用车体验；不要使用和新车一模一样等类似词汇，需要加入“几乎”等模糊副词，不得绝对化表达。",
  "ref-video-019":
