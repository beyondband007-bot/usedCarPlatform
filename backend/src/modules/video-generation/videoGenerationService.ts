...
> = {
  ...
  "ref-video-006": {
    title: "车场介绍 4｜规模现车",
    referenceRole: "车辆品质源头价值营销，强调车源优质、层层质检合格，强化品牌形象。",
    styleTags: ["车场介绍", "车源品质", "质检合格", "品牌形象", "数字人口播"],
    stylePrompt:
      "精品二手车销售口播风格。数字人以车场销售身份介绍车源品质与质检流程，强调车源优质、层层质检合格，强化品牌形象；避免绝对化承诺。",
    shotPlan15s: [
      {
        timeRange: "0-3s",
...
const videoTemplateNarrationInstructionById: Record<string, string> = {
  "ref-video-006":
    "用于介绍车卖场，站在车辆品质源头价值营销的角度，强调车源优质、层层质检合格，强化品牌形象；避免绝对化承诺。",
  "ref-video-008":
    "用于介绍车卖场，站在车源充足、选择丰富、更新稳定的经营实力角度，提升到店咨询与成交转化；必须模糊表达，不说具体多少辆。",
  "ref-video-009":
    "用于介绍车卖场，站在库存更新节奏稳定、每周都有新车到店的角度，让客户随时都有新车源可看、可选；不要夸大宣传。",
  "ref-video-010":
    "用于介绍车卖场，站在真实车况展示与诚信经营表达的角度，建立客户信任，减少看车顾虑。",
  "ref-video-011":
    "用于介绍车卖场，站在严选精品车、拒收泡水车与重大事故车的角度，展现车源优质、车况透明；避免绝对化承诺。",
  "ref-video-012":
    "用于介绍车卖场，站在买车后有问题能联系、能沟通、有人对接的角度，让本地及海外客户都更安心；不要夸大宣传。",
  "ref-video-013":
    "用于介绍车卖场，站在真实车况呈现与合理价格说明的角度，降低远程看车顾虑，让客户更安心咨询。",
  "ref-video-014":
    "用于介绍车卖场，站在全天候运营与及时沟通能力的角度，提升客户信任度，营造品牌可靠口碑。",
  "ref-video-015":
    "用于介绍车卖场，站在全天候运营与及时沟通能力的角度，提升客户信任度，营造品牌可靠口碑。",
  "ref-video-007":
    "用于介绍用户上传的车辆，站在适配海外市场需求、手续资料相对齐全等优势的角度，提升客户远程咨询与采购信心；不要夸大宣传。",
  "ref-video-016":
    "用于介绍用户上传的车型，站在展示外观成色、漆面光泽与整体质感的角度，提升客户看车兴趣与咨询意愿；不得使用绝对化表达。",
  "ref-video-017":
    "用于介绍用户上传车辆，站在呈现加速响应、行驶质感与核心工况的角度，让客户更直观判断车辆状态；不要使用“完美”等过于绝对化的形容词。",
