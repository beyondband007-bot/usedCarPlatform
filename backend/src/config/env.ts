...
export const env = {
  ...
  maxVideoUploadMb: toNumber(process.env.MAX_VIDEO_UPLOAD_MB, 50),
  maxVideoUploadDurationSeconds: toNumber(process.env.MAX_VIDEO_UPLOAD_DURATION_SECONDS, 60),
  platformStorageBudgetGb: toNumber(process.env.PLATFORM_STORAGE_BUDGET_GB, 100),
