export const migrations = [
  ...
  `CREATE TABLE IF NOT EXISTS vehicle_libraries (
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    INDEX idx_vehicle_libraries_tenant (tenant_id),
    INDEX idx_vehicle_libraries_owner (owner_user_id),
    INDEX idx_vehicle_libraries_status (status)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,

  `CREATE TABLE IF NOT EXISTS vehicle_lots (
    id VARCHAR(64) NOT NULL,
    library_id VARCHAR(64) NOT NULL,
    name VARCHAR(100) NOT NULL,
    address VARCHAR(255) NULL,
    remark VARCHAR(500) NULL,
    material_status VARCHAR(20) NOT NULL DEFAULT 'incomplete',
    status VARCHAR(20) NOT NULL DEFAULT 'active',
    created_by_user_id VARCHAR(64) NOT NULL,
    updated_by_user_id VARCHAR(64) NULL,
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    INDEX idx_vehicle_lots_library_status (library_id, status),
    INDEX idx_vehicle_lots_material_status (library_id, material_status),
    INDEX idx_vehicle_lots_created_at (created_at)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,
  ...
  `CREATE TABLE IF NOT EXISTS vehicles (
    ...
    vin CHAR(17) NULL,
    identify_type VARCHAR(20) NOT NULL DEFAULT 'manual',
    ...
    energy_type VARCHAR(40) NULL,
    fuel_grade VARCHAR(40) NULL,
    displacement VARCHAR(40) NULL,
    transmission VARCHAR(40) NULL,
    vehicle_level VARCHAR(40) NULL,
    emission_standard VARCHAR(80) NULL,
    color VARCHAR(40) NULL,
    mileage_km INT UNSIGNED NULL,
    first_registration_date DATE NULL,
    guide_price DECIMAL(12,2) NULL,
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    UNIQUE KEY uk_vehicles_library_vin (library_id, vin),
    INDEX idx_vehicles_library_status (library_id, status),
    INDEX idx_vehicles_lot (lot_id),
    INDEX idx_vehicles_brand_series (library_id, brand, series),
    INDEX idx_vehicles_material_status (library_id, material_status),
    INDEX idx_vehicles_created_at (created_at)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,

  `CREATE TABLE IF NOT EXISTS vehicle_library_materials (
    id VARCHAR(64) NOT NULL,
    library_id VARCHAR(64) NOT NULL,
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    UNIQUE KEY uk_vehicle_library_material_slot (owner_type, owner_id, slot_code),
    INDEX idx_vehicle_library_materials_library (library_id),
    INDEX idx_vehicle_library_materials_owner (owner_type, owner_id),
    INDEX idx_vehicle_library_materials_asset (asset_id),
    INDEX idx_vehicle_library_materials_status (status, audit_status)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,

  `CREATE TABLE IF NOT EXISTS vehicle_recognition_records (
    id VARCHAR(64) NOT NULL,
    library_id VARCHAR(64) NOT NULL,
    vehicle_id VARCHAR(64) NULL,
    recognition_type VARCHAR(20) NOT NULL,
    input_vin VARCHAR(32) NULL,
    source_asset_id VARCHAR(64) NULL,
    recognized_vin CHAR(17) NULL,
    ...
    created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    INDEX idx_vehicle_recognition_library (library_id, created_at),
    INDEX idx_vehicle_recognition_vehicle (vehicle_id),
  ...
  `CREATE TABLE IF NOT EXISTS language_conversion_tasks (
    ...
    source_duration_seconds INT NOT NULL DEFAULT 60,
    billable_minutes INT NOT NULL DEFAULT 1,
    source_file_name VARCHAR(255) NOT NULL,
    ...
    INDEX idx_language_conversion_tasks_billing_task (billing_task_id),
    INDEX idx_language_conversion_tasks_billing_status (billing_status)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,
];
