...
- [Phase 1 contract](./reusable-credits-phases/reusable-credits-integration-contract.md)
- [Phase 2 credits platform setup](./reusable-credits-phases/reusable-credits-phase-2-credits-platform-setup.md)
- [Phase 3 DB fields](./reusable-credits-phases/reusable-credits-phase-3-db-fields.md)
- [Phase 4 backend client](./reusable-credits-phases/reusable-credits-phase-4-backend-client.md)
- [Phase 5 terminal billing](./reusable-credits-phases/reusable-credits-phase-5-terminal-billing.md)
- [Phase 6 batch creation](./reusable-credits-phases/reusable-credits-phase-6-batch-billing.md)
- [Phase 7 proxy APIs](./reusable-credits-phases/reusable-credits-phase-7-proxy-apis.md)
- [Phase 8 frontend credit data](./reusable-credits-phases/reusable-credits-phase-8-frontend-credit-data.md)
- [Phase 9 admin console](./reusable-credits-phases/reusable-credits-phase-9-admin-console.md)
- [Phase 10 mock identity](./reusable-credits-phases/reusable-credits-phase-10-mock-identity.md)
- [Phase 11 E2E testing](./reusable-credits-phases/reusable-credits-phase-11-e2e-testing.md)
- [Phase 12 team handoff](./reusable-credits-phases/reusable-credits-phase-12-team-handoff.md)
